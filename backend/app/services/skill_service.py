...
from app.utils.skill_manager import load_skill, list_available_skills
from app.config import get_llm

class SkillService:
    def __init__(self, skills_dir: str = None):
        from app.config.settings import SKILL_DIR
    ...
    def list_available_skills(self) -> List[Dict]:
        ...
        # 使用 utils 中的 list_available_skills 函数获取技能列表
        skill_ids = list_available_skills()
